...
echo "   - Simple streaming: ./scripts/run_flink_example.sh simple"
echo "   - Windowed aggregations: ./scripts/run_flink_example.sh windowed"
echo "   - CDC processing: ./scripts/run_flink_example.sh cdc"
echo ""
